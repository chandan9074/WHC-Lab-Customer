...
const TermsConditionsSection = () => {
    return (
        <div className="flex flex-col gap-4">
            ...
            <Description
                value={
                    "These terms and conditions outline the rules and regulations for the use of WHC-Labs Website, located at https://whclab.staging.zaagsys.com By accessing this website we assume you accept these terms and conditions. Do not continue to use WHC-Lab if you do not agree to take all of the terms and conditions stated on this page."
                }
            />
            <Description
